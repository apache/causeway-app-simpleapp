...
[TIP]
====
If all you want is get a feel for what the framework is all about, then take a look at the link:https://github.com/apache/isis-hello-world[hello world] starter app, which is even simpler.
====
